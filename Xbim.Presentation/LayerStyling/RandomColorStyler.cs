...
namespace Xbim.Presentation.LayerStyling
{
    public class RandomColorStyler : ILayerStyler, IProgressiveLayerStyler
    {
        ...
        /// <param name="selectContexts"></param>
        /// <returns></returns>
        public XbimScene<WpfMeshGeometry3D, WpfMaterial> BuildScene(IModel model, XbimMatrix3D modelTransform, 
            ModelVisual3D opaqueShapes, ModelVisual3D transparentShapes, List<IPersistEntity> isolateInstances = null, List<IPersistEntity> hideInstances = null, List<IIfcGeometricRepresentationContext> selectContexts = null, List<Type> excludeTypes = null)
        {
